...
import { Heading, Card, CardBody, CardFooter, Text, KiwiRoundIcon, Flex, Skeleton } from '@kiwifinancebsc/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} KIWI</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
