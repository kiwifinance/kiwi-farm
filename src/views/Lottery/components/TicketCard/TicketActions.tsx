...
import { Button, useModal } from '@kiwifinancebsc/uikit'
...
const TicketCard: React.FC = () => {
  ...
  const [onPresentBuy] = useModal(<BuyTicketModal max={kiwiBalance} tokenName="KIWI" />)
      ...
      return (
        <>
          ...
          <Button fullWidth disabled={requestedApproval} onClick={handleApprove}>
            {TranslateString(999, 'Approve KIWI')}
          </Button>
        </>
      )
    }
