...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@kiwifinancebsc/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy KIWI and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get KIWI-BNB LP tokens by adding KIWI and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://cheeseswap.app/#/swap?inputCurrency=0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c&outputCurrency=0x2cc26dd730f548dc4ac291ae7d84a0c96980d2cb" mr="16px">
              {TranslateString(999, 'Buy Kiwi')}
            </LinkExternal>
            <LinkExternal href="https://swap.kiwifinance.app/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
              {TranslateString(999, 'Get LP tokens')}
            </LinkExternal>
          </Flex>
          <Heading mb="16px">{TranslateString(600, 'During Sale')}:</Heading>
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your KIWI-LP tokens to buy the IFO tokens')}</li>
          </List>
